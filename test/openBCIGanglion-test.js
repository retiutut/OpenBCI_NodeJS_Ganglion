...
describe('#ganglion', function () {
  ...
  describe('#_bled112DeviceFound', function () {
    it('should be able to parse for data', function () {
      const rawBuf = Buffer.from([0x80, 0x1A, 0x06, 0x00, 0xCD, 0x00, 0xD9, 0x66, 0xCE, 0x00, 0x53, 0xE9, 0x01, 0xFF, 0x0F, 0x0E, 0x09, 0x47, 0x61, 0x6E, 0x67, 0x6C, 0x69, 0x6F, 0x6E, 0x2D, 0x35, 0x34, 0x63, 0x61]);

      const expectedAddressType = 1;
      const expectedAdvertiseDataString = 'Ganglion-54ca';
      const expectedAdvertiseDataRaw = Buffer.from([0x0E, 0x09, 0x47, 0x61, 0x6E, 0x67, 0x6C, 0x69, 0x6F, 0x6E, 0x2D, 0x35, 0x34, 0x63, 0x61]);
  ...
  describe('#_bled112ParseForRaws', function () {
    ...
    it('should be able to get one find info found with long uuid', function () {
      const expectedFindInfoLong = Buffer.from([0x80, 0x14, 0x04, 0x04, 0x01, 0x19, 0x00, 0x10, 0x96, 0x05, 0x48, 0xEA, 0x84, 0x34, 0x3F, 0x92, 0xE6, 0x4C, 0x9F, 0xF3, 0x82, 0xC0, 0x30, 0x2D]);
    ...
    it('should be able to get one find info found with real long uuid', function () {
      const expectedFindInfoLong = Buffer.from([0x80, 0x14, 0x04, 0x04, 0x00, 0x19, 0x00, 0x10, 0x96, 0x05, 0x48, 0xea, 0x84, 0x34, 0x3f, 0x92, 0xe6, 0x4c, 0x9f, 0xf3, 0x82, 0xc0, 0x30, 0x2d]);
    ...
    it('should be able to get one find info found with long, short, long', function () {
      const expectedFindInfoLong1 = Buffer.from([0x80, 0x14, 0x04, 0x04, 0x01, 0x19, 0x00, 0x10, 0x96, 0x05, 0x48, 0xEA, 0x84, 0x34, 0x3F, 0x92, 0xE6, 0x4C, 0x9F, 0xF3, 0x82, 0xC0, 0x30, 0x2D]);
      const expectedFindInfoShort = Buffer.from([0x80, 0x06, 0x04, 0x04, 0x01, 0x1A, 0x00, 0x02, 0x02, 0x29]);
      const expectedFindInfoLong2 = Buffer.from([0x80, 0x14, 0x04, 0x04, 0x01, 0x19, 0x00, 0x10, 0x96, 0x05, 0x48, 0xEA, 0x84, 0x34, 0x3F, 0x92, 0xE6, 0x4C, 0x9F, 0xF3, 0x82, 0xC0, 0x30, 0x2C]);
    ...
    it('should be able to get one find info found with long, short and return half of long', function () {
      ...
      const expectedFindInfoShort = Buffer.from([0x80, 0x06, 0x04, 0x04, 0x01, 0x1A, 0x00, 0x02, 0x02, 0x29]);
      const expectedHalfFindInfoLong = Buffer.from([0x80, 0x14, 0x04, 0x04, 0x01, 0x19, 0x00, 0x10, 0x96, 0x05]);
